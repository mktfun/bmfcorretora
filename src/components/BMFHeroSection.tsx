    ...
    <section className="relative w-full overflow-hidden h-screen bg-black" style={{ height: '100dvh' }}>
      ...
      <nav className="absolute top-0 left-0 right-0 z-[100] px-6 py-6 flex items-center justify-between pointer-events-auto">
        ...
        <div className="hidden lg:flex items-center gap-8 bg-white/5 backdrop-blur-lg border border-white/10 px-8 py-3 rounded-full shadow-glow">
          ...
          <Link to="/consorcios" className="text-white/90 hover:text-cyan-400 transition-colors text-sm font-medium">Consórcios</Link>
          <Link to="/planos-de-vida" className="text-white/90 hover:text-cyan-400 transition-colors text-sm font-medium">Planos de Vida</Link>
          <Link to="/sobre-nos" className="text-white/90 hover:text-cyan-400 transition-colors text-sm font-medium">Sobre Nós</Link>
        </div>
