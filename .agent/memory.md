...
- **Headers Identificadores nos Wizards**: Todo wizard deve iniciar com um Header customizado contendo um Ícone Laranja (`w-8 h-8 text-[#e8702a]`), Título Playfair (ex: `h2 className="text-2xl font-playfair font-semibold text-white"`), subtítulo, e separador de borda (`border-b border-white/10 pb-4 mb-6`) inseridos **acima** do `<Stepper>`.
