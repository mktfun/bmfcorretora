...
- **Componentes de Grid para Opções Nativas (MaritalStatusGrid & RadioCardGroup)**: O estado inativo usa Pills em Glassmorphism (`bg-white/5 text-white/70`). O estado ativo deve **obrigatoriamente usar Laranja** (`bg-[#e8702a]/20 border-[#e8702a] text-white shadow-[0_0_15px_rgba(232,112,42,0.2)]`). Bolinhas nativas de radio/check devem ser removidas para manter interface limpa.
